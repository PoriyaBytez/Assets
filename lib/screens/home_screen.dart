...
import '../api/models/subcategories2_model.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  saveEditValue() {
    if (edit != null) {
      ...
      // categoryItem = edit?.category ?? "";
      // subCategoryItem1 = edit?.subcategory1 ?? "";
      // subCategoryItem2 = edit?.subcategory2 ?? "";
      // locationItem = edit?.location ?? "";
      // ownerItem = edit?.owner ?? "";
                  ...
                  Row(
                    children: [
                      Expanded(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Common.commonContainer(tag),
                        ),
                      ),
                      Expanded(
                          child: Padding(
